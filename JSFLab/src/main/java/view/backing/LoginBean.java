...
public class LoginBean {
    ...
    public String login() {
        if (username.toLowerCase().equals("scott") && password.toLowerCase().equals("tiger")) {
            FacesContext facesContext = FacesContext.getCurrentInstance();
            ResourceBundle resourceBundle = ResourceBundle.getBundle("ApplicationMessages", facesContext.getViewRoot().getLocale());
            FacesMessage errorMessage = new FacesMessage();
            errorMessage.setSeverity(FacesMessage.SEVERITY_ERROR);
            errorMessage.setSummary(resourceBundle.getString("validation.oracle"));
            errorMessage.setDetail("oracle");
